...
export const ENDPOINT_MAP = [
  ...
  {"a3": "sound", "ng": {"method": "POST", "path": "/api/v1/sounds/play"}, "body": "sound"},
  {"a3": "rtttl", "ng": {"method": "POST", "path": "/api/v1/sounds/play"}, "body": "rtttlRaw"},
  {"a3": "r2d2", "ng": {"method": "POST", "path": "/api/v1/sounds/play"}, "body": "r2d2"},
...
export const TOPIC_MAP = [
  ...
  {"a3": "sound", "ng": "cmd/sounds/play", "body": "sound"},
  {"a3": "rtttl", "ng": "cmd/sounds/play", "body": "rtttlRaw"},
  {"a3": "r2d2", "ng": "cmd/sounds/play", "body": "r2d2"},
